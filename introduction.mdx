...
<AccordionGroup>
  ...
  <Accordion title="⚡ Fast Processing">
    Most images come back in a few seconds. Process thousands of images without breaking a sweat.
  </Accordion>
  ...
  <Accordion title="📦 Simple Integration">
    Two endpoints. One API key. SDKs for popular languages and platforms.
  </Accordion>
</AccordionGroup>
