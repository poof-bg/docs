...
<Tabs>
  ...
  <Tab title="pnpm">
    ```bash
    pnpm add @poof-bg/sdk
    ```
  </Tab>
  <Tab title="yarn">
    ```bash
    yarn add @poof-bg/sdk
    ```
  </Tab>
  <Tab title="bun">
    ```bash
...
```typescript
import { Poof, PoofError, AuthenticationError, PaymentRequiredError, RateLimitError } from '@poof-bg/sdk';
...
- [npm Package](https://www.npmjs.com/package/@poof-bg/sdk)
